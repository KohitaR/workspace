...
//    cout << "TestFile : " << test << endl;
    ...
    vector<vector<Conllu>> train_sentences = readconllu("/home/ryosuke-k/workspace/data/ja_ktc-ud-dev.conllu.word");
    ...
    vector<vector<string>> test_sentences = readtest("/home/ryosuke-k/workspace/data/ja_ktc-ud-test.conllu.word");
    vector<vector<Conllu>> eval_sentences = readconllu("/home/ryosuke-k/workspace/data/ja_ktc-ud-test.conllu.word");
